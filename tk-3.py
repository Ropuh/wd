...
##
menuTools = Menu(pasekMenu, tearoff=0)
pasekMenu.add_cascade(label="Narzędzia", menu=menuTools)

menuTools.add_command(label="Tool 1", command=akcja)
menuTools.add_separator()
menuTools.add_command(label="Tools 2", command=akcja)
##
